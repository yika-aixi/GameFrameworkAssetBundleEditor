...
namespace UnityGameFramework.Runtime
{
    ...
    public static class GameEntry
    {
        ...
        private static readonly LinkedList<MonoBehaviour> s_GameFrameworkComponents = new LinkedList<MonoBehaviour>();
        ...
        {
            LinkedListNode<MonoBehaviour> current = s_GameFrameworkComponents.First;
            while (current != null)
            {
        ...
        /// <returns>要获取的游戏框架组件。</returns>
        public static MonoBehaviour GetComponent(string typeName)
        {
            LinkedListNode<MonoBehaviour> current = s_GameFrameworkComponents.First;
            while (current != null)
            {
        ...
        /// 注册游戏组件。
        /// </summary>
        /// <param name="gameFrameworkComponent">注册游戏组件。</param>
        internal static void RegisterComponent(MonoBehaviour component)
        {
            if (component == null)
            {
