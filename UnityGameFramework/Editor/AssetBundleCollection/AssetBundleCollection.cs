...
namespace Icarus.UnityGameFramework.Editor.AssetBundleTools
{
    ...
    internal sealed class AssetBundleCollection
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<AssetBundleCollectionConfigPathAttribute>() ?? Icarus.GameFramework.Utility.Path.GetCombinePath(Application.dataPath, "GameFramework/Configs/AssetBundleCollection.xml");
