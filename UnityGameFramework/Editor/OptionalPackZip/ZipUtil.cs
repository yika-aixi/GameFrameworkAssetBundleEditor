...
namespace Icarus.UnityGameFramework.Editor
{
    public static class ZipUtil
    {
        ...
        {
            var dir = Path.GetDirectoryName(outZipFilePath);
...
//        static string getTest_Zip()
//        {
//            return Application.persistentDataPath + "/a.zip";
//        }
//        [MenuItem("Icarus/Game Framework/Test/更新 zip")]
//        static void UpdateZip()
//        {
//            var file1 = File.Create(Application.persistentDataPath + "/1.txt");
//            file1.Close();
//            file1.Dispose();
//            var file2 = File.Create(Application.persistentDataPath + "/2.txt");
//            file2.Close();
//            file2.Dispose();
//            var file3 = File.Create(Application.persistentDataPath + "/gameframeworkassetbundleeditor/3.txt");
//            file3.Close();
//            file3.Dispose();
//            
//            UpdateZipAdd(getTest_Zip(), Application.persistentDataPath, new string[]
//            {
//                Application.persistentDataPath+"1.txt",
//                Application.persistentDataPath+"2.txt",
//                Application.persistentDataPath + "/gameframeworkassetbundleeditor/3.txt"
//            });
//        }
        ...
        /// 解压压缩包,会覆盖文件
        /// </summary>
        [MenuItem("Icarus/Game Framework/Test/解压更新包")]
        public static void UnzipZip(string zipFilePath)
        {
            var file = File.Open(zipFilePath, FileMode.Open);
            _unzipFromStream(file, Application.persistentDataPath);
        }
